        ...
        <div>
          ...
          {state === 'Completed' ? (
            <div className='flex items-center justify-center px-2 py-1 mt-2 bg-green-100 rounded-full'>
              <p className='text-xs leading-3 text-green-700'>Completed</p>
            </div>
          ) : state === 'Pending' ? (
            <div className='flex items-center justify-center px-2 py-1 mt-2 bg-yellow-100 rounded-full'>
              <p className='text-xs leading-3 text-yellow-700'>Pending</p>
            </div>
          ) : (
            <div className='flex items-center justify-center px-2 py-1 mt-2 bg-red-100 rounded-full'>
              <p className='text-xs leading-3 text-red-700'>Closed</p>
            </div>
          )}
        </div>
      </td>
